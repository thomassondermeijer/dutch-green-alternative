            ...
            <div>
                ...
                <div className={styles.formSection}>
                    ...
                    <div className={styles.paymentMethods}>
                        {[
                            { id: "ideal", label: "iDEAL", icon: "/icons/payments/ideal.svg" },
                            { id: "bancontact", label: "Bancontact", icon: "/icons/payments/bancontact.svg" },
                            { id: "creditcard", label: "Credit Card", icon: "/icons/payments/creditcard.svg" },
                            { id: "sofortbanking", label: "SOFORT", icon: "/icons/payments/sofort.svg" },
                            { id: "invoice", label: dict.checkout.payOnInvoice || "Pay on Invoice", icon: "/icons/payments/invoice.svg" },
                        ].map((method) => (
                            <label
                                key={method.id}
                            ...
                            >
                                ...
                                <img src={method.icon} alt={method.label} className={styles.paymentIcon} width="40" height="28" />
